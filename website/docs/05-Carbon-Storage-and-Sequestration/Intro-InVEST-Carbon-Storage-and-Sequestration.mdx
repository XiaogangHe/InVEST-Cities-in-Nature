...
Before running the InVEST Carbon Storage and Sequestration Model, you need to download all necessary data [here](https://xiaoganghe.github.io/InVEST-Cities-in-Nature/docs/Carbon-Storage-and-Sequestration/data).

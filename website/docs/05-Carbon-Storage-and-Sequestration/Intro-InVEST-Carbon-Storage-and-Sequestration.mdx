...
- `/tot_c_fut.tif  
- `/intermediate_outputs/`   
- `/intermediate_outputs/c_above_cur.tif`  
- `/intermediate_outputs/c_above_fut.tif`   
- `/intermediate_outputs/c_below_cur.tif` 
- `/intermediate_outputs/c_below_fut.tif`   
- `/intermediate_outputs/c_dead_cur.tif`  
- `/intermediate_outputs/c_dead_fut.tif`   
- `/intermediate_outputs/c_soil_cur.tif`  
- `/intermediate_outputs/c_soil_fut.tif`

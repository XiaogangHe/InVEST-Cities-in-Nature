...
- Note: More detailed descriptions about the outputs of the InVEST Coastal Vulnerability Model also can refer to this [link](https://storage.googleapis.com/releases.naturalcapitalproject.org/invest-userguide/latest/urban_flood_mitigation.html#data-needs).  

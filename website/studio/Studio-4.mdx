...
4.	Show evaluation of solution(s) to assess the strengths and weakness of the solutions. Include discussion on how solutions are strong/weak based on how they impact and contribute to the national agenda/interest. To also include analysis from at least one InVEST model.
...
6.	Discuss the strengths and limitations of Jakarta’s approaches 
